...
import { Taskbar, TodolistComponent } from "../../shared/components";
import { BaseLayout } from "../../shared/layout";
import type { Istep, Itodo, Iuser } from "../../shared/interfaces";
...
export const Teste2 = () => {
  ...
  const filters = [{ id: "1", type: "date", label: "26/06/2025" }];
  ...
  return (
    <Box ml={8} display="flex">
      <Box flex={1} mr={2}>
        <BaseLayout title="Planejado" status={[]} users={users}>
          <TodolistComponent
